        ...
        className="border border-gray-300 rounded px-4 py-2 w-64" />
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={decrement}
              disabled={quantity === 1}
              className={`px-6 py-3 font-black text-2xl border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] uppercase ${quantity === 1
            ...
            <button
              ...
              className={`px-6 py-3 font-black text-2xl border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] uppercase ${quantity === 20
                  ? "bg-gray-400 text-gray-600 cursor-not-allowed"
                  : "bg-lime-400 text-black hover:bg-lime-300 active:shadow-none active:translate-x-1 active:translate-y-1"}`}
            >
              +

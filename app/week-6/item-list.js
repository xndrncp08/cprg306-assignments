...
export default function ItemList({ items }) {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-gradient-to-br from-purple-400 via-pink-300 to-blue-400 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] w-[28rem] border-4 border-black mx-auto rounded-lg">
      <h1
